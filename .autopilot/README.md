...
|---|---|---|---|
| 2026-08-28 | `2026-08-28-tg-lead-catcher--wip` | в работе (переоткрыт 2026-09-02) | Telegram-лидогенератор: userbot ловит сообщения по ключевым словам в выбранных чатах, пересылает в приёмники с карточкой источника; вся настройка — через бота-панель (источники/приёмники/ключи/настройки), без правки кода. 9 тасков + 3 круга доводки, 179 тестов зелёные, Docker-сборка и `pip install` проверены вживую. Переоткрыт: баг найден в ручном использовании (команда во время FSM-ввода в панели сохранялась как значение) — тикет 11. |
